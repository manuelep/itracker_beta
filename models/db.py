...
if not request.env.web2py_runtime_gae:
    ...
    dburi = myconf.take('db.uri_dev') if myconf.take('app.development', cast=int) else myconf.take('db.uri')
    db = DAL(dburi, pool_size=myconf.take('db.pool_size', cast=int), check_reserved=['all'])
else:
