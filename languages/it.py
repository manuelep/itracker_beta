...
'<': '<',
'<=': '<=',
'<div><span aria-hidden="true" class="glyphicon glyphicon-apple"></span>New issue</div>': '<div><span aria-hidden="true" class="glyphicon glyphicon-apple"></span>New issue</div>',
'=': '=',
'>': '>',
'>=': '>=',
...
'Back': 'Indietro',
'Browse by projects': 'Browse by projects',
...
'Export:': 'Esporta:',
'FAQ': 'FAQ',
'Fired! Deadline passed and issue still open!': 'Fired! Deadline passed and issue still open!',
'First name': 'Nome',
...
'Hide closed issues': 'Hide closed issues',
'Home': 'Home',
...
'MARKMIN text syntax is accepted. Max length is 255.': 'MARKMIN text syntax is accepted. Max length is 255.',
'Menu Model': 'Menu Modelli',
'Milestones': 'Milestones',
'Modified By': 'Modificato da',
'Modified On': 'Modificato il',
'My active issues': 'My active issues',
'My issues': 'My issues',
...
'Relax! No deadline fixed.': 'Relax! No deadline fixed.',
'reload': 'reload',
...
'Tasks': 'Tasks',
'Tasks for project:': 'Tasks for project:',
